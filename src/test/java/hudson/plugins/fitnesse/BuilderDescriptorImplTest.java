...
public class BuilderDescriptorImplTest {
	...
	public void emptyHostShouldBeError() throws Exception {
		Assert.assertEquals(Kind.ERROR, descriptor.doCheckFitnesseHost("").kind);
	}

	@Test
	public void emptyPortShouldBeError() throws Exception {
		Assert.assertEquals(Kind.ERROR, descriptor.doCheckFitnessePort("").kind);
	}

	@Test
	public void nonNumericPortShouldBeError() throws Exception {
		Assert.assertEquals(Kind.ERROR, descriptor.doCheckFitnessePort("a").kind);
	}

	@Test
	public void negativePortShouldBeError() throws Exception {
		Assert.assertEquals(Kind.ERROR, descriptor.doCheckFitnessePort("-1").kind);
	}

	@Test
	public void emptyPathToFitnesseJarShouldBeError() throws Exception {
		Assert.assertEquals(Kind.ERROR, descriptor.doCheckFitnessePathToJar("").kind);
	}
	...
	public void emptyPathToFitnesseRootShouldBeError() throws Exception {
		Assert.assertEquals(Kind.ERROR, descriptor.doCheckFitnessePathToRoot("").kind);
	}
	...
	public void emptyTargetPageShouldBeError() throws Exception {
		Assert.assertEquals(Kind.ERROR, descriptor.doCheckFitnesseTargetPage("").kind);
	}
	...
	public void nonExistentFitnesseResultsShouldBeOK() throws Exception {
		Assert.assertEquals(Kind.OK, descriptor.doCheckFitnessePathToXmlResultsOut("aldhfashf.xml").kind);
	}
	...
	public void incorrectlyEndedFitnesseResultsShouldBeWarning() throws Exception {
		...
		Assert.assertEquals(Kind.WARNING, descriptor.doCheckFitnessePathToXmlResultsOut(tmpFile.getAbsolutePath()).kind);
	}
	...
	public void correctlyEndedFitnesseResultsShouldBeOk() throws Exception {
		...
		Assert.assertEquals(Kind.OK, descriptor.doCheckFitnessePathToXmlResultsOut(tmpFile.getAbsolutePath()).kind);
	}

	@Test
	public void emptyJavaWorkingDirectoryShouldBeOk() throws Exception {
		Assert.assertEquals(Kind.OK, descriptor.doCheckFitnesseJavaWorkingDirectory("").kind);
	}
	...
	public void nonExistentJavaWorkingDirectoryShouldBeError() throws Exception {
		...
		Assert.assertEquals(Kind.ERROR, descriptor.doCheckFitnesseJavaWorkingDirectory(noSuchDirectory).kind);
	}
	...
	public void emptyHttpTimeoutShouldBeOk() throws Exception {
		Assert.assertEquals(Kind.OK, descriptor.doCheckFitnesseHttpTimeout("").kind);
	}

	@Test
	public void nonNumericHttpTimeoutShouldBeError() throws Exception {
		Assert.assertEquals(Kind.ERROR, descriptor.doCheckFitnesseHttpTimeout("a").kind);
	}

	@Test
	public void negativeHttpTimeoutShouldBeError() throws Exception {
		Assert.assertEquals(Kind.ERROR, descriptor.doCheckFitnesseHttpTimeout("-1").kind);
	}

	@Test
	public void positiveHttpTimeoutShouldBeOk() throws Exception {
		Assert.assertEquals(Kind.OK, descriptor.doCheckFitnesseHttpTimeout("1").kind);
	}
}
